...
| Provider `network_interface` (UTM 5.0.4+) | AppleScript update network VLAN/DHCP properties |
| Provider `reload_configuration` (UTM 5.0.4+) | AppleScript `reload configuration` |
